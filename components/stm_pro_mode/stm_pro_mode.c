...
void initGPIO(void)
{
    ...
    //gpio_set_direction(BOOT1_PIN, GPIO_MODE_OUTPUT);
    //gpio_set_level(BOOT1_PIN, LOW);

//    gpio_set_direction(MOSFET_CONTROL1, GPIO_MODE_OUTPUT);
//    gpio_set_level(MOSFET_CONTROL1, HIGH);
//    gpio_set_direction(MOSFET_CONTROL2, GPIO_MODE_OUTPUT);
//    gpio_set_level(MOSFET_CONTROL2, HIGH);

    gpio_set_direction(RELAY_CONTROL, GPIO_MODE_OUTPUT);
    gpio_set_level(RELAY_CONTROL, HIGH);
...
//    gpio_set_level(MOSFET_CONTROL1, LOW);
//    gpio_set_level(MOSFET_CONTROL2, LOW);

    gpio_set_level(RELAY_CONTROL, LOW);
