...
#define TXD_PIN (GPIO_NUM_17) //(GPIO_NUM_1)
#define RXD_PIN (GPIO_NUM_16) //(GPIO_NUM_3)
...
//#define MOSFET_CONTROL1 (GPIO_NUM_22)
//#define MOSFET_CONTROL2 (GPIO_NUM_23)
#define RELAY_CONTROL (GPIO_NUM_23)
#define HIGH 1
#define LOW 0
